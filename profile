...
alias thunderbird='thunderbird --profile $XDG_DATA_HOME/thunderbird/mf89m0u7.default-release'
alias rclone='rclone --vfs-cache-mode full --cache-dir ~/.cache/rclone'
